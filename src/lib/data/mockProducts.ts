...
export const collections: Collection[] = [
  ...
  { id: 'c6', name: 'Custom Orders', slug: 'custom-orders' },
...
export const testimonials: Testimonial[] = [
  ...
  { id: 't2', name: "Priya M.", location: "Bangalore", text: "I commissioned a custom piece to match my Kanjeevaram saree, and the artist delivered beyond my expectations. Eco-conscious and beautiful.", rating: 5 },
...
export const mockProducts: Product[] = [
  // Terracotta Sets (16)
  {
    ...
    longDescription: "The Mridula set is a testament to the artisan's skill, featuring delicate brushstrokes outlining traditional motifs on earthen clay. The set includes a statement necklace and matching statement jhumkas. Perfect for festive occasions and pairs beautifully with handloom sarees.",
    ...
    stockStatus: 'in_stock', stockQuantity: 5, isNew: true, isBestseller: true, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 3, isNew: false, isBestseller: true, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x800/e8d5cc/7D2E24?text=Aarohi+Beaded'], materials: ['Terracotta Beads', 'Wood', 'Cotton Thread'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 8, isNew: false, isBestseller: false, isSale: true, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x800/F5F2ED/5C554E?text=Mira+Set'], materials: ['Terracotta', 'Silver-plated chains'],
    careInstructions: careInstructionsDefault, stockStatus: 'made_to_order', stockQuantity: 0, isNew: true, isBestseller: false, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x800/D9D1C1/7D2E24?text=Pallavi+3D'], materials: ['Terracotta', 'Natural Dyes', 'Golden Beads'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 2, isNew: false, isBestseller: true, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x800/E5E1D8/7D2E24?text=Devika+Choker'], materials: ['Terracotta', 'Brass Ghungroos'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 4, isNew: false, isBestseller: false, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x800/FDFCF8/2D2926?text=Nandini+Abstract'], materials: ['Terracotta', 'Acrylic Colors', 'Cotton Dori'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 5, isNew: true, isBestseller: false, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x800/E5E1D8/2D2926?text=Surya+Chandrakala'], materials: ['Terracotta', 'Gold Foil Details'],
    careInstructions: careInstructionsDefault, stockStatus: 'made_to_order', stockQuantity: 0, isNew: false, isBestseller: true, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x800/F5F2ED/5C554E?text=Ananya+Modern'], materials: ['Terracotta', 'Wax Cord'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 6, isNew: false, isBestseller: true, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x800/E5E1D8/7D2E24?text=Kalyani+Regular'], materials: ['Terracotta', 'Cotton Thread'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 10, isNew: false, isBestseller: false, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x800/D9D1C1/2D2926?text=Kavya+Set'], materials: ['Terracotta', 'Paints', 'Beads'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 4, isNew: true, isBestseller: false, isSale: false, isCustomisable: false, tags: ['peacock', 'festive', 'art'], occasion: ['Traditional Function'], colorFamily: ['Blue', 'Green', 'Gold'], createdAt: '2023-11-20'
  },
  {
    ...
    images: ['https://placehold.co/600x800/E5E1D8/B35C38?text=Raga+Hansuli'], materials: ['Terracotta'],
    careInstructions: careInstructionsDefault, stockStatus: 'made_to_order', stockQuantity: 0, isNew: false, isBestseller: false, isSale: false, isCustomisable: true, tags: ['tribal', 'hansuli', 'bold'], occasion: ['Festive', 'Gifting'], colorFamily: ['Black', 'White', 'Red'], createdAt: '2023-03-22'
  },
  {
    ...
    images: ['https://placehold.co/600x800/E5E1D8/7D2E24?text=Bindu+Beaded'], materials: ['Terracotta Beads', 'Thread'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 6, isNew: false, isBestseller: false, isSale: false, isCustomisable: false, tags: ['beaded', 'boho', 'layers'], occasion: ['Office Wear', 'Daily Wear'], colorFamily: ['Brown', 'Terracotta'], createdAt: '2023-02-15'
  },
  {
    ...
    images: ['https://placehold.co/600x800/F5F2ED/5C554E?text=Tushar+Modern'], materials: ['Terracotta', 'Metal Rings'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 3, isNew: false, isBestseller: false, isSale: true, isCustomisable: false, tags: ['modern', 'geometric'], occasion: ['College / Gen-Z'], colorFamily: ['Silver', 'Grey'], createdAt: '2023-01-10'
  },
  {
    ...
    images: ['https://placehold.co/600x800/E5E1D8/B35C38?text=Lata+3D'], materials: ['Terracotta'],
    careInstructions: careInstructionsDefault, stockStatus: 'made_to_order', stockQuantity: 0, isNew: false, isBestseller: false, isSale: false, isCustomisable: true, tags: ['sculptural', 'lotus', 'heavy'], occasion: ['Wedding Guest'], colorFamily: ['Pink', 'Green', 'Gold'], createdAt: '2023-08-25'
  },
  {
    ...
    images: ['https://placehold.co/600x800/F5F2ED/7D2E24?text=Dhara+Regular'], materials: ['Terracotta', 'Cotton'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 20, isNew: false, isBestseller: true, isSale: false, isCustomisable: true, tags: ['simple', 'return-gift'], occasion: ['Gifting', 'Daily Wear'], colorFamily: ['Terracotta'], createdAt: '2023-09-01'
  },
  ...
  // Earrings (12)
  {
    ...
    images: ['https://placehold.co/600x600/E5E1D8/7D2E24?text=Amra+Jhumka'], materials: ['Terracotta', 'Brass Hooks'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 12, isNew: false, isBestseller: true, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/F5F2ED/5C554E?text=Neelika+Painted'], materials: ['Terracotta', 'Acrylic', 'Silver-plated Hooks'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 8, isNew: true, isBestseller: false, isSale: true, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/D9D1C1/7D2E24?text=Tara+3D'], materials: ['Terracotta', 'Gold polished hooks'],
    careInstructions: careInstructionsDefault, stockStatus: 'made_to_order', stockQuantity: 0, isNew: false, isBestseller: true, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/E5E1D8/B35C38?text=Mrinal+Textured'], materials: ['Raw Terracotta'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 15, isNew: false, isBestseller: false, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/F5F2ED/5C554E?text=Bindu+Cone'], materials: ['Terracotta', 'Metallic Paint'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 5, isNew: true, isBestseller: false, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/E5E1D8/7D2E24?text=Diya+Studs'], materials: ['Terracotta', 'Steel Posts'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 20, isNew: false, isBestseller: true, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/D9D1C1/2D2926?text=Sitara+Painted'], materials: ['Terracotta'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 6, isNew: false, isBestseller: false, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/E5E1D8/7D2E24?text=Malathi+Jhumka'], materials: ['Terracotta', 'Ghungroos'],
    careInstructions: careInstructionsDefault, stockStatus: 'out_of_stock', stockQuantity: 0, isNew: false, isBestseller: false, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/F5F2ED/5C554E?text=Bhavya+Painted'], materials: ['Terracotta', 'Acrylic'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 8, isNew: true, isBestseller: false, isSale: false, isCustomisable: false, tags: ['tribal', 'abstract'], occasion: ['Office Wear'], colorFamily: ['Multicolor', 'Black'], createdAt: '2023-11-25'
  },
  {
    ...
    images: ['https://placehold.co/600x600/E5E1D8/7D2E24?text=Rati+3D'], materials: ['Terracotta', 'Paints'],
    careInstructions: careInstructionsDefault, stockStatus: 'made_to_order', stockQuantity: 0, isNew: false, isBestseller: false, isSale: false, isCustomisable: true, tags: ['rose', 'sculptural', 'floral'], occasion: ['Festive'], colorFamily: ['Red', 'Green'], createdAt: '2023-09-15'
  },
  {
    ...
    images: ['https://placehold.co/600x600/FDFCF8/2D2926?text=Nisha+Textured'], materials: ['Terracotta'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 10, isNew: false, isBestseller: false, isSale: false, isCustomisable: false, tags: ['hoops', 'hammered', 'textured'], occasion: ['Daily Wear'], colorFamily: ['Terracotta', 'Brown'], createdAt: '2023-10-05'
  },
  {
    ...
    images: ['https://placehold.co/600x600/E5E1D8/B35C38?text=Gita+Elephant'], materials: ['Terracotta', 'Steel Posts'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 15, isNew: false, isBestseller: true, isSale: true, isCustomisable: false, tags: ['elephant', 'cute', 'studs'], occasion: ['Gifting', 'Daily Wear'], colorFamily: ['Grey', 'Black'], createdAt: '2023-03-12'
  },
  ...
  // Accessories (8)
  {
    ...
    images: ['https://placehold.co/600x600/D9D1C1/7D2E24?text=Kamala+Ring'], materials: ['Terracotta', 'Adjustable Brass Base'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 10, isNew: true, isBestseller: false, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/F5F2ED/5C554E?text=Navya+Ring'], materials: ['Terracotta', 'Adjustable Base'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 12, isNew: false, isBestseller: true, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/E5E1D8/7D2E24?text=Ruchika+Bangle'], materials: ['Terracotta'],
    careInstructions: careInstructionsDefault, stockStatus: 'made_to_order', stockQuantity: 0, isNew: false, isBestseller: false, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/F5F2ED/B35C38?text=Pritha+Bangle'], materials: ['Terracotta', 'Mirrors'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 4, isNew: true, isBestseller: false, isSale: false, isCustomisable: true, tags: ['bangle', 'mirrors', 'set'], occasion: ['Festive'], colorFamily: ['Red', 'Green', 'Silver'], createdAt: '2023-11-05'
  },
  {
    ...
    images: ['https://placehold.co/600x600/D9D1C1/2D2926?text=Vasanti+Clip'], materials: ['Terracotta', 'Metal French Barrette'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 5, isNew: true, isBestseller: false, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/E5E1D8/2D2926?text=Mayur+Brooch'], materials: ['Terracotta', 'Pin Back'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 8, isNew: false, isBestseller: true, isSale: false, isCustomisable: true,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/FDFCF8/5C554E?text=Lavanya+Pin'], materials: ['Terracotta', 'Brass Plated Steel'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 15, isNew: false, isBestseller: false, isSale: false, isCustomisable: false,
  ...
  },
  {
    ...
    images: ['https://placehold.co/600x600/D9D1C1/7D2E24?text=Shikha+Stick'], materials: ['Terracotta', 'Sandalwood'],
    careInstructions: careInstructionsDefault, stockStatus: 'in_stock', stockQuantity: 4, isNew: true, isBestseller: false, isSale: false, isCustomisable: false,
