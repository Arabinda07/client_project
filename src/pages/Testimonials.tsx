  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
      ...
      <div className="mb-14 max-w-3xl sm:mb-16">
        ...
        <p className="text-gray-600 type-body-large">Notes of love from our wonderful community.</p>
      </div>

      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2">
        {testimonials.map((t, i) => (
          <div key={i} className="flex flex-col items-start rounded-[2px] border border-border-soft bg-surface p-8 text-left clay-shadow-soft">
            <div className="mb-4 flex gap-1 text-antique-gold">
